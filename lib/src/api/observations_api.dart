...
class ObservationsApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ObservationGeoModel>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ObservationGeoModel>>> geoList({ 
    String? boundaryUuid,
    int? countryId,
    ...
    String? identificationTaxonIdsLookup,
    bool? negateIdentificationTaxonIds,
    ...
    final _path = r'/observations/geo/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (identificationTaxonIdsLookup != null) r'identification_taxon_ids_lookup': encodeQueryParameter(_serializers, identificationTaxonIdsLookup, const FullType(String)),
      if (negateIdentificationTaxonIds != null) r'negate_identification_taxon_ids': encodeQueryParameter(_serializers, negateIdentificationTaxonIds, const FullType(bool)),
    ...
    BuiltList<ObservationGeoModel>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(ObservationGeoModel)]),
      ) as BuiltList<ObservationGeoModel>;
    ...
    return Response<BuiltList<ObservationGeoModel>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
