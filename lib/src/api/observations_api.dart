...
class ObservationsApi {
  ...
  Future<Response<Observation>> observationsCreate({ 
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> observationsDestroy({ 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaginatedObservationList>> observationsList({ 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ObservationPrediction>> observationsPredictionCreate({ 
    required String uuid,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> observationsPredictionDestroy({ 
    required String uuid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [ObservationPrediction] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ObservationPrediction>> observationsPredictionRetrieve({ 
    required String uuid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [Observation] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Observation>> observationsRetrieve({ 
    required String uuid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
