...
class CountriesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [PaginatedCountryList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaginatedCountryList>> list({ 
    int? page,
    int? pageSize,
    ...
    PaginatedCountryList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedCountryList),
      ) as PaginatedCountryList;
    ...
    return Response<PaginatedCountryList>(
      data: _responseData,
  ...
  Future<Response<Country>> retrieve({ 
    ...
    final _path = r'/countries/{id}/'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
