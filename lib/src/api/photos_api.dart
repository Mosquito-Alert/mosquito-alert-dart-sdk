...
class PhotosApi {
  ...
  Future<Response<void>> predictionDestroy({ 
    ...
    final _path = r'/photos/{uuid}/prediction/'.replaceAll('{' r'uuid' '}', encodeQueryParameter(_serializers, uuid, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PhotoPrediction>> predictionPartialUpdate({ 
    required String uuid,
  ...
  /// Returns a [Future] containing a [Response] with a [PhotoPrediction] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PhotoPrediction>> predictionUpdate({ 
    required String uuid,
  ...
  Future<Response<Photo>> retrieve({ 
    ...
    final _path = r'/photos/{uuid}/'.replaceAll('{' r'uuid' '}', encodeQueryParameter(_serializers, uuid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
