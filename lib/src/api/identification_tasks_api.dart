...
class IdentificationTasksApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [IdentificationTaskCapabilities] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdentificationTaskCapabilities>> capabilitiesRetrieve({ 
    required String observationUuid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/identification-tasks/{observation_uuid}/capabilities/'.replaceAll('{' r'observation_uuid' '}', encodeQueryParameter(_serializers, observationUuid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    IdentificationTaskCapabilities? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(IdentificationTaskCapabilities),
      ) as IdentificationTaskCapabilities;
    ...
    return Response<IdentificationTaskCapabilities>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
