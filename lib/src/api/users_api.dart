...
class UsersApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CreateUser] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateUser>> usersCreate({ 
    ...
    CreateUser? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateUser),
      ) as CreateUser;
