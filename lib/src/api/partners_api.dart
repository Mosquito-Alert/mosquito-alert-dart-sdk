...
class PartnersApi {
  ...
  Future<Response<PaginatedPartnerList>> list({ 
    ...
    PaginatedPartnerList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedPartnerList),
      ) as PaginatedPartnerList;
    ...
    return Response<PaginatedPartnerList>(
      data: _responseData,
  ...
  Future<Response<Partner>> retrieve({ 
    ...
    final _path = r'/partners/{id}/'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
