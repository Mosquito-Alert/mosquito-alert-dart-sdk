...
class DevicesApi {
  ...
  Future<Response<Device>> devicesCreate({ 
    ...
    try {
      const _type = FullType(DeviceRequest);
      _bodyData = _serializers.serialize(deviceRequest, specifiedType: _type);
  ...
  Future<Response<DeviceUpdate>> devicesPartialUpdate({ 
    ...
    final _path = r'/devices/{device_id}/'.replaceAll('{' r'device_id' '}', encodeQueryParameter(_serializers, deviceId, const FullType(String)).toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(PatchedDeviceUpdateRequest);
      _bodyData = patchedDeviceUpdateRequest == null ? null : _serializers.serialize(patchedDeviceUpdateRequest, specifiedType: _type);
    ...
    DeviceUpdate? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DeviceUpdate),
      ) as DeviceUpdate;
  ...
  Future<Response<DeviceUpdate>> devicesUpdate({ 
    ...
    try {
      const _type = FullType(DeviceUpdateRequest);
      _bodyData = _serializers.serialize(deviceUpdateRequest, specifiedType: _type);
