...
class CampaignsApi {
  ...
  Future<Response<PaginatedCampaignList>> campaignsList({ 
    ...
    PaginatedCampaignList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedCampaignList),
      ) as PaginatedCampaignList;
    ...
    return Response<PaginatedCampaignList>(
      data: _responseData,
  ...
  Future<Response<Campaign>> campaignsRetrieve({ 
    ...
    final _path = r'/campaigns/{id}/'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
