...
class JwtAuthInterceptor extends QueuedInterceptor {
  ...
  JwtAuthInterceptor(
      ...
      : _authApi = apiClient.getAuthApi(),
        _dio = dio ?? Dio(apiClient.dio.options);
  ...
  void onError(DioException err, ErrorInterceptorHandler handler) async {
    ...
    try {
      ...
      final tokenRefreshResponse = await _authApi.refreshToken(
      ...
      handler.reject(RevokeTokenException(requestOptions: err.requestOptions));
      return;
    }
    ...
    final retryResponse =
        await _dio.fetch<Response<dynamic>>(err.requestOptions);
