...
const ErrorResponse404TypeEnum
    _$errorResponse404TypeEnum_unknownDefaultOpenApi =
    const ErrorResponse404TypeEnum._('unknownDefaultOpenApi');
...
ErrorResponse404TypeEnum _$errorResponse404TypeEnumValueOf(String name) {
  switch (name) {
    ...
    case 'unknownDefaultOpenApi':
      return _$errorResponse404TypeEnum_unknownDefaultOpenApi;
    default:
      return _$errorResponse404TypeEnum_unknownDefaultOpenApi;
  }
}
...
class _$ErrorResponse404 extends ErrorResponse404 {
  ...
  factory _$ErrorResponse404(
      ...
      (ErrorResponse404Builder()..update(updates))._build();
  ...
  ErrorResponse404Builder toBuilder() =>
      ErrorResponse404Builder()..replace(this);
...
class ErrorResponse404Builder
  ...
  ListBuilder<Error404> get errors =>
      _$this._errors ??= ListBuilder<Error404>();
