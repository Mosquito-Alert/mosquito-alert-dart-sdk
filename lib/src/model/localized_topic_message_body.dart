...
part 'localized_topic_message_body.g.dart';
...
/// * [zhCn] - 简体中文
@BuiltValue()
abstract class LocalizedTopicMessageBody implements Built<LocalizedTopicMessageBody, LocalizedTopicMessageBodyBuilder> {
  /// Български
  ...
  LocalizedTopicMessageBody._();

  factory LocalizedTopicMessageBody([void updates(LocalizedTopicMessageBodyBuilder b)]) = _$LocalizedTopicMessageBody;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LocalizedTopicMessageBodyBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LocalizedTopicMessageBody> get serializer => _$LocalizedTopicMessageBodySerializer();
}

class _$LocalizedTopicMessageBodySerializer implements PrimitiveSerializer<LocalizedTopicMessageBody> {
  @override
  final Iterable<Type> types = const [LocalizedTopicMessageBody, _$LocalizedTopicMessageBody];

  @override
  final String wireName = r'LocalizedTopicMessageBody';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    LocalizedTopicMessageBody object, {
  ...
  void _deserializeProperties(
    ...
    required LocalizedTopicMessageBodyBuilder result,
  ...
  @override
  LocalizedTopicMessageBody deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LocalizedTopicMessageBodyBuilder();
