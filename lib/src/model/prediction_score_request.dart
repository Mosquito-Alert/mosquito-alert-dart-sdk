...
part 'prediction_score_request.g.dart';
...
@BuiltValue()
abstract class PredictionScoreRequest implements Built<PredictionScoreRequest, PredictionScoreRequestBuilder> {
  ...
  PredictionScoreRequest._();

  factory PredictionScoreRequest([void updates(PredictionScoreRequestBuilder b)]) = _$PredictionScoreRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PredictionScoreRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PredictionScoreRequest> get serializer => _$PredictionScoreRequestSerializer();
}

class _$PredictionScoreRequestSerializer implements PrimitiveSerializer<PredictionScoreRequest> {
  @override
  final Iterable<Type> types = const [PredictionScoreRequest, _$PredictionScoreRequest];

  @override
  final String wireName = r'PredictionScoreRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PredictionScoreRequest object, {
  ...
  void _deserializeProperties(
    ...
    required PredictionScoreRequestBuilder result,
  ...
  @override
  PredictionScoreRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PredictionScoreRequestBuilder();
