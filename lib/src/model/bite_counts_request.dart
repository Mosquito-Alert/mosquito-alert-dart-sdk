...
part 'bite_counts_request.g.dart';
...
@BuiltValue()
abstract class BiteCountsRequest implements Built<BiteCountsRequest, BiteCountsRequestBuilder> {
  ...
  factory BiteCountsRequest([void updates(BiteCountsRequestBuilder b)]) = _$BiteCountsRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BiteCountsRequestBuilder b) => b
      ..head = 0
      ..leftArm = 0
      ..rightArm = 0
      ..chest = 0
  ...
  static Serializer<BiteCountsRequest> get serializer => _$BiteCountsRequestSerializer();
}

class _$BiteCountsRequestSerializer implements PrimitiveSerializer<BiteCountsRequest> {
  @override
  final Iterable<Type> types = const [BiteCountsRequest, _$BiteCountsRequest];

  @override
  final String wireName = r'BiteCountsRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BiteCountsRequest object, {
  ...
  void _deserializeProperties(
    ...
    required BiteCountsRequestBuilder result,
  ...
  @override
  BiteCountsRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BiteCountsRequestBuilder();
