...
part 'localized_message_body.g.dart';
...
/// * [zhCN] - 中文（中国）
@BuiltValue()
abstract class LocalizedMessageBody implements Built<LocalizedMessageBody, LocalizedMessageBodyBuilder> {
  /// Български
  ...
  LocalizedMessageBody._();

  factory LocalizedMessageBody([void updates(LocalizedMessageBodyBuilder b)]) = _$LocalizedMessageBody;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LocalizedMessageBodyBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LocalizedMessageBody> get serializer => _$LocalizedMessageBodySerializer();
}

class _$LocalizedMessageBodySerializer implements PrimitiveSerializer<LocalizedMessageBody> {
  @override
  final Iterable<Type> types = const [LocalizedMessageBody, _$LocalizedMessageBody];

  @override
  final String wireName = r'LocalizedMessageBody';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    LocalizedMessageBody object, {
  ...
  void _deserializeProperties(
    ...
    required LocalizedMessageBodyBuilder result,
  ...
  @override
  LocalizedMessageBody deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LocalizedMessageBodyBuilder();
