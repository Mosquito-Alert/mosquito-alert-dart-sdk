...
const MessagesListErrorAttrEnum _$messagesListErrorAttrEnum_target =
    const MessagesListErrorAttrEnum._('target');
...
MessagesListErrorAttrEnum _$messagesListErrorAttrEnumValueOf(String name) {
  switch (name) {
    case 'target':
      return _$messagesListErrorAttrEnum_target;
...
final BuiltSet<MessagesListErrorAttrEnum> _$messagesListErrorAttrEnumValues =
    BuiltSet<MessagesListErrorAttrEnum>(const <MessagesListErrorAttrEnum>[
  _$messagesListErrorAttrEnum_target,
  _$messagesListErrorAttrEnum_unknownDefaultOpenApi,
]);
...
class _$MessagesListError extends MessagesListError {
  ...
  factory _$MessagesListError(
      ...
      (MessagesListErrorBuilder()..update(updates))._build();
  ...
  MessagesListErrorBuilder toBuilder() =>
      MessagesListErrorBuilder()..replace(this);
