...
part of 'localized_message_title_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$LocalizedMessageTitleRequest extends LocalizedMessageTitleRequest {
  @override
  final String? bg;
  @override
  final String? bn;
  ...
  _$LocalizedMessageTitleRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        en, r'LocalizedMessageTitleRequest', 'en');
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is LocalizedMessageTitleRequest &&
        bg == other.bg &&
        bn == other.bn &&
        ca == other.ca &&
        de == other.de &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'LocalizedMessageTitleRequest')
          ..add('bg', bg)
          ..add('bn', bn)
          ..add('ca', ca)
          ..add('de', de)
...
class LocalizedMessageTitleRequestBuilder
    implements
        Builder<LocalizedMessageTitleRequest,
            LocalizedMessageTitleRequestBuilder> {
  _$LocalizedMessageTitleRequest? _$v;
  ...
  LocalizedMessageTitleRequestBuilder() {
    LocalizedMessageTitleRequest._defaults(this);
  }

  LocalizedMessageTitleRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _bg = $v.bg;
      _bn = $v.bn;
  ...
  @override
  void update(void Function(LocalizedMessageTitleRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  LocalizedMessageTitleRequest build() => _build();
