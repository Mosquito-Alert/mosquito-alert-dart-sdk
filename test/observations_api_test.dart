...
void main() {
  ...
  group(ObservationsApi, () {
    ...
    //Future<PaginatedObservationList> list({ DateTime createdAtAfter, DateTime createdAtBefore, bool hasPhotos, String locationAdmNuts2, String locationAdmNuts3, int locationCountryId, BuiltList<String> orderBy, int page, int pageSize, DateTime receivedAtAfter, DateTime receivedAtBefore, String shortId, DateTime updatedAtAfter, DateTime updatedAtBefore, String userUuid }) async
    ...
    //
    //Future<PaginatedObservationList> listMine({ DateTime createdAtAfter, DateTime createdAtBefore, bool hasPhotos, String locationAdmNuts2, String locationAdmNuts3, int locationCountryId, BuiltList<String> orderBy, int page, int pageSize, DateTime receivedAtAfter, DateTime receivedAtBefore, String shortId, DateTime updatedAtAfter, DateTime updatedAtBefore, String userUuid }) async
